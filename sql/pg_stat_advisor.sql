...
EXPLAIN (ANALYZE, COSTS OFF, TIMING OFF, SUMMARY OFF, BUFFERS OFF) SELECT * FROM t WHERE i = 100 AND j = 10;
SELECT pg_sleep(1);
...
-- Check order of name
EXPLAIN (ANALYZE, COSTS OFF, TIMING OFF, SUMMARY OFF, BUFFERS OFF) SELECT * FROM t WHERE j = 10 AND i = 100;
SELECT pg_sleep(1);
SELECT stxname, stxkeys, stxkind FROM pg_statistic_ext;
SELECT analyze_count FROM pg_stat_all_tables WHERE relname = 't';
DROP STATISTICS t_i_j_stat;
...
EXPLAIN (ANALYZE, COSTS OFF, TIMING OFF, SUMMARY OFF, BUFFERS OFF) SELECT * FROM t WHERE i = 100 OR j = 10;
SELECT pg_sleep(1);
SELECT stxname, stxkeys, stxkind FROM pg_statistic_ext;
SELECT analyze_count FROM pg_stat_all_tables WHERE relname = 't';
...
EXPLAIN (ANALYZE, COSTS OFF, TIMING OFF, SUMMARY OFF, BUFFERS OFF) SELECT * FROM temp WHERE i = 100 AND j = 10;
SELECT pg_sleep(1);
SELECT stxname, stxkeys, stxkind FROM pg_statistic_ext;
SELECT analyze_count FROM pg_stat_all_tables WHERE relname = 'temp';
...
EXPLAIN (ANALYZE, COSTS OFF, TIMING OFF, SUMMARY OFF, BUFFERS OFF) SELECT * FROM t2 WHERE i = 100 AND j = 10;
SELECT pg_sleep(1);
SELECT stxname, stxkeys, stxkind FROM pg_statistic_ext;
SELECT analyze_count FROM pg_stat_all_tables WHERE relname = 't2';
...
VACUUM ANALYZE t2;
SELECT analyze_count FROM pg_stat_all_tables WHERE relname = 't2';
EXPLAIN (ANALYZE, COSTS OFF, TIMING OFF, SUMMARY OFF, BUFFERS OFF) SELECT * FROM t2 WHERE i = 100 AND j = 10 AND k = 1;
SELECT pg_sleep(1);
SELECT stxname, stxkeys, stxkind FROM pg_statistic_ext;
SELECT analyze_count FROM pg_stat_all_tables WHERE relname = 't2';
